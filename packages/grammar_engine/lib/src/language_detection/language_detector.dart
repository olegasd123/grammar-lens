...
class LanguageDetector {
  ...
  Map<SupportedLanguage, double> detectWithConfidence(String text) {
    if (text.trim().length < 20) {
      return {for (final lang in SupportedLanguage.values) lang: lang == SupportedLanguage.english ? 1.0 : 0.0};
    }
  ...
  static Map<String, double> _extractTrigrams(String text) {
    ...
    final cleaned = text.replaceAll(RegExp(r'[^a-záéíóúñüàèìòùâêîôûäëïöüçãõ\s]'), '');
    ...
    return {
      for (final entry in trigrams.entries)
  ...
  static const _profiles = <SupportedLanguage, Map<String, double>>{
    SupportedLanguage.english: {
      'the': 0.035, ' th': 0.033, 'he ': 0.025, 'and': 0.018,
      'nd ': 0.016, 'ion': 0.015, 'tio': 0.014, ' an': 0.014,
      'ing': 0.013, 'ng ': 0.012, 'ent': 0.011, ' in': 0.011,
      'ati': 0.010, 'on ': 0.010, 'er ': 0.009, 'hat': 0.009,
      'is ': 0.009, 'for': 0.008, 'his': 0.008, 'all': 0.008,
      'tha': 0.008, 'ter': 0.007, ' to': 0.007, 'ore': 0.007,
      ' of': 0.007, 'of ': 0.007, 'in ': 0.007, ' fo': 0.006,
      'nt ': 0.006, 'ver': 0.006, ' co': 0.006, 'ere': 0.006,
    },
    SupportedLanguage.spanish: {
      'de ': 0.028, ' de': 0.025, ' la': 0.020, 'la ': 0.018,
      'os ': 0.016, 'en ': 0.015, ' en': 0.014, 'ión': 0.014,
      'ció': 0.013, 'que': 0.012, 'ue ': 0.011, ' el': 0.011,
      'el ': 0.010, ' qu': 0.010, 'es ': 0.010, 'as ': 0.009,
      'aci': 0.009, 'con': 0.008, ' co': 0.008, 'nte': 0.008,
      ' lo': 0.008, 'los': 0.007, 'las': 0.007, 'do ': 0.007,
      'al ': 0.007, ' pa': 0.007, 'par': 0.006, 'ara': 0.006,
      'est': 0.006, 'sta': 0.006, ' un': 0.006, 'una': 0.006,
    },
    SupportedLanguage.french: {
      'es ': 0.022, ' de': 0.020, 'de ': 0.018, ' le': 0.016,
      'ent': 0.015, 'le ': 0.014, 'on ': 0.013, ' la': 0.013,
      'la ': 0.012, 'ion': 0.012, 'tio': 0.011, 'ati': 0.010,
      ' et': 0.010, 'et ': 0.009, ' en': 0.009, 'en ': 0.009,
      'les': 0.009, ' un': 0.008, 'ons': 0.008, 'des': 0.008,
      ' co': 0.008, 'nt ': 0.008, ' pa': 0.007, 'par': 0.007,
      ' qu': 0.007, 'que': 0.007, 'ue ': 0.007, 're ': 0.007,
      'une': 0.006, 'ne ': 0.006, 'men': 0.006, ' da': 0.006,
    },
    SupportedLanguage.german: {
      'en ': 0.028, 'er ': 0.022, 'die': 0.018, ' di': 0.017,
      'ie ': 0.016, 'der': 0.015, 'und': 0.014, ' un': 0.014,
      'nd ': 0.013, 'ein': 0.012, 'ich': 0.011, 'den': 0.010,
      'che': 0.010, ' de': 0.010, 'sch': 0.009, ' ei': 0.009,
      'in ': 0.009, 'ine': 0.009, 'eit': 0.008, 'gen': 0.008,
      'ung': 0.008, 'das': 0.008, ' da': 0.007, ' in': 0.007,
      'ber': 0.007, 'ter': 0.007, 'nte': 0.007, 'nen': 0.007,
      'ach': 0.006, 'auf': 0.006, ' au': 0.006, 'hen': 0.006,
    },
    SupportedLanguage.portuguese: {
      'de ': 0.025, ' de': 0.022, 'os ': 0.018, ' qu': 0.016,
      'que': 0.015, 'ue ': 0.014, 'ão ': 0.013, 'ção': 0.012,
      ' o ': 0.012, ' co': 0.011, 'as ': 0.011, 'do ': 0.010,
      'ent': 0.010, 'con': 0.009, ' pa': 0.009, 'par': 0.009,
      'ara': 0.009, 'com': 0.008, 'est': 0.008, ' es': 0.008,
      ' do': 0.008, ' em': 0.008, 'em ': 0.007, ' se': 0.007,
      ' um': 0.007, 'uma': 0.007, 'nte': 0.007, ' da': 0.007,
      ' no': 0.007, 'no ': 0.007, 'da ': 0.006, 'dos': 0.006,
      'mos': 0.006, 'ado': 0.006, 'men': 0.006, 'osa': 0.005,
      'oso': 0.005, ' na': 0.005,
    },
  };
}
